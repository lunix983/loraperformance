...
logpath = "/Users/Luix/PycharmProjects/iotelasticproject/var/log/iotnetworkserver/"
...
def insert_metric():
    try:
            ...
            througput = ( float(packetsize) * float(delay) ) / 1000
            ...
            with open(filename, "aw") as fo:
                 fo.write(timestamp+","+idnode+","+sequencenum +","+snr+","+rssi+","+temperature+","+umidity+","+nodelocation+","+delay+","+lorasetup+","+packetsize+","+expid+","+gwlocation+","+txpower+","+str(througput)+"\n")
